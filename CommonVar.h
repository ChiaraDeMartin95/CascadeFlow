...
// TString SinputFileName = "LHC23zzh_pass3_Train226234_CFW";
//  TString SinputFileName = "LHC23_PbPb_pass3_Train218607"; //<--the largest dataset so far, no info about SP
...
TString ComputeResoFileNameCFW = "TreeForAnalysis/AnalysisResults_LHC23zzh_pass3_Train226234_CFW.root"; //<-- central framework

// Files with stored resolution
TString ResoFileName_EPLF = "Resolution/Resolution_EP_LF.root";
TString ResoFileName_EPCFW = "Resolution/Resolution_EP_CFW.root";
TString ResoFileName_SPLF = "Resolution/Resolution_SP_LF.root";
TString ResoFileName_SPCFW = "Resolution/Resolution_SP_CFW.root";