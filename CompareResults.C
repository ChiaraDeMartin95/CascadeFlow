                    ...
                    Bool_t UseTwoGauss = ExtrUseTwoGauss)
{
  ...
  // TypeComp == 66 --> Compare Pzs2 of Lambda (from single file) vs sum #Lambda + #bar{#Lambda} polarization
  ...
  else if (TypeComp == 54)
  {
    ...
    CommonFileName = "../Pzs2VsCentrality/Pzs2_LHC25_OO_pass2_Train742311_Lambda_DSCB_BkgCheb_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly";
    fileName[0] = "_EffW";
    fileName[1] = "_TighterPzFitRange_EffW";
    namehisto[0] = "fHistPzs";
    namehisto[1] = "fHistPzs";
    hTitleX = "FT0C centrality (%)";
    sleg[0] = "Default";
  ...
  else if (TypeComp == 56)
  {
    ...
    YUpRatio = 1.1;
    sleg[0] = "Looser sel.";
    sleg[1] = "Default"; // the new acceptance is now the default one
    MinHistoX = -0.8;
    MaxHistoX = 0.8;
    // MinHistoX = 0.5;
    // MaxHistoX = 10;
  ...
  else if (TypeComp == 70)
  {
    ...
    fileName[1] = "_Train598891_EtaPos_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly";
  ...
  else if (TypeComp == 84)
  {
    ...
    namehisto[2] = "Cos2ThetaLambdaFromCVsEta_cent0-50";
    hTitleY = "Cos^{2}(#theta_{p})";
    hTitleX = "#eta";
    YLow = 0;
    YUp = 0.5;
    ...
    if (isPt == 1)
    {
      ...
      namehisto[2] = "Cos2ThetaLambdaFromCVsPt_cent0-50";
      MinHistoX = 0.5;
      MaxHistoX = 10;
      hTitleX = "p_{T} (GeV/c)";
      AdditionalName = "_Pt";
  ...
  else if (TypeComp == 87)
  {
    ...
    CommonFileName = "../Pzs2VsCentrality/Pzs2_LHC25_OO_pass2_Train";
    fileName[0] = "598890_MyEff_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
    fileName[1] = "753645_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
    namehisto[0] = "fHistPzs";
    namehisto[1] = "fHistPzs";
    hTitleX = "FT0C centrality (%)";
    sleg[0] = "default";
  ...
  else if (TypeComp == 88)
  {
    ...
    if (isPt == 1)
    {
      CommonFileName = "../Pzs2VsPt/Pzs2_LHC25_OO_pass2_Train";
      fileName[0] = "598890_MyEff_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
      fileName[1] = "753645_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
      namehisto[0] = "histoPzs2";
      namehisto[1] = "histoPzs2";
      MinHistoX = 0.5;
      MaxHistoX = 6;
  ...
  else if (TypeComp == 89)
  {
    ...
    isRatio = 1;
    isFitRatio = 1;
    isFullCorr = 1; // fully correlated results
    isStoreSyst = 0;
    TypeSyst = "";
    // CommonFileName = "../Pzs2VsCentrality/Pzs2_LHC25_OO_pass2_Train";
    // fileName[0] = "598890_MyEff_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
    // fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacroOriginal_ResoOnTheFly_EffW";
    // namehisto[0] = "fHistPzs";
    // namehisto[1] = "fHistPzs";
    CommonFileName = "../Pzs2VsPt/Pzs2_LHC25_OO_pass2_Train";
    fileName[0] = "598890_MyEff_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_ResoOnTheFly_EffW";
    fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacroOriginal_ResoOnTheFly_EffW";
    namehisto[0] = "histoPzs2";
    namehisto[1] = "histoPzs2";
    hTitleX = "FT0C centrality (%)";
    sleg[0] = "default";
    sleg[1] = "AcceptanceInMacro";
    // YLow = 0.;
    // YUp = 0.5;
    // YLowRatio = -0.006;
    // YUpRatio = 0.006;
  ...
  else if (TypeComp == 90)
  {
    ...
    CommonFileName = "../Pzs2VsCentrality/Pzs2_LHC25_OO_pass2_Train";
    fileName[0] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
    fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacroAllLambdas_ResoOnTheFly_EffW";
    namehisto[0] = "fHistPzs";
    namehisto[1] = "fHistPzs";
    hTitleX = "FT0C centrality (%)";
    sleg[0] = "Acc. #Lambda or #bar{#Lambda}";
    sleg[1] = "Acc. all #Lambda";
    YLowRatio = 0.95;
    YUpRatio = 1.05;
    YLow = -0.002;
    YUp = 0.02;
    ...
    if (isPt == 1)
    {
      CommonFileName = "../Pzs2VsPt/Pzs2_LHC25_OO_pass2_Train";
      fileName[0] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
      fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacroAllLambdas_ResoOnTheFly_EffW";
      namehisto[0] = "histoPzs2";
      namehisto[1] = "histoPzs2";
      MinHistoX = 0.5;
      MaxHistoX = 6;
  ...
  else if (TypeComp == 91)
  {
    ...
    if (isPt == 1)
    {
      CommonFileName = "../Pzs2VsPt/Pzs2_LHC25_OO_pass2_Train";
      fileName[0] = "742311_Lambda_DSCB_BkgCheb_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
      fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
      namehisto[0] = "histoPzs2";
      namehisto[1] = "histoPzs2";
      hTitleX = "p_{T} (GeV/c)";
      MinHistoX = 0.5;
    ...
    else if (isPt == 2)
    {
      CommonFileName = "../PzVsPsi/Pzs2_LHC25_OO_pass2_Train";
      fileName[0] = "742311_Lambda_DSCB_BkgCheb_Pzs2_CentWeighted_vsPsi_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
      fileName[1] = "742311_Lambda_BkgParab_Pzs2_CentWeighted_vsPsi_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
      namehisto[0] = "histoPz";
      namehisto[1] = "histoPz";
      hTitleX = "2(#varphi - #Psi_{2})";
      MinHistoX = 0;
  ...
  else if (TypeComp == 92)
  {
    ...
    isStoreSyst = 0;
    TypeSyst = "";
    CommonFileName = "../OutputAnalysis/V2_LHC25_OO_pass2_Train742311";
    fileName[0] = "_LambdaPart_CentWeighted_EffW_WithAlpha_Eta08_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly";
    fileName[1] = "_AntiLambda_CentWeighted_EffW_WithAlpha_Eta08_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly";
    namehisto[0] = "Pzs2_cent0-50_pt4";
    namehisto[1] = "Pzs2_cent0-50_pt4";
    hTitleX = "inv. mass (GeV/#it{c}^{2})";
    sleg[0] = "#Lambda";
    sleg[1] = "#bar{#Lambda}";
    YLowRatio = -0.05;
    YUpRatio = 0.05;
  ...
  else if (TypeComp == 93)
  {
    ...
    fileName[0] = "_LambdaPart_CentWeighted_EffW_WithAlpha_Eta08_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly";
    fileName[1] = "_AntiLambda_CentWeighted_EffW_WithAlpha_Eta08_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly";
    namehisto[0] = "mass_cent40-50_pt8";
    namehisto[1] = "mass_cent40-50_pt8";
    hTitleX = "inv. mass (GeV/#it{c}^{2})";
    sleg[0] = "#Lambda";
    sleg[1] = "#bar{#Lambda}";
    YLowRatio = 0.8;
  ...
  else if (TypeComp == 94)
  {
    ...
    CommonFileName = "../Pzs2VsCentrality/Pzs2_LHC25_OO_pass2_Train";
    fileName[0] = "742311_Lambda_DSCB_BkgCheb_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
    fileName[1] = "742311_AntiLambda_DSCB_BkgCheb_Pzs2_CentWeighted_PtInt_Eta08_TightMassCut2.1_ReducedPtBins_AcceptanceInMacro_ResoOnTheFly_EffW";
    namehisto[0] = "fHistPzs";
    namehisto[1] = "fHistPzs";
    hTitleX = "FT0C centrality (%)";
    sleg[0] = "#Lambda";
  ...
  else if (TypeComp == 95)
  {
    ...
    isStoreSyst = 0;
    TypeSyst = "Acceptance";
    CommonFileName = "../AcceptancePlots/Acceptance_LHC25_OO_pass2_Train598890_Lambda_EffW_WithAlpha_Eta08";
    fileName[0] = "_isOOCentrality_TightAcceptance";
    fileName[1] = "_isLoosest_isSysLambdaMultTrial_isOOCentrality_TightAcceptance";
    fileName[2] = "_isTightest_isSysLambdaMultTrial_isOOCentrality_TightAcceptance";
    namehisto[0] = "Cos2ThetaLambdaFromCVsPt_cent0-50";
    namehisto[1] = "Cos2ThetaLambdaFromCVsPt_cent0-50";
    namehisto[2] = "Cos2ThetaLambdaFromCVsPt_cent0-50";
    // namehisto[0] = "Cos2ThetaLambdaFromCVsEta_cent0-50";
  ...
  if (TypeComp == 48)
    cgaus->SaveAs(Form("../CompareResults/GaussianDistribution_TypeComp%i%s.png", TypeComp, AdditionalName.Data()));
...
*/
  ...
  TH1F *hDummy = new TH1F("hDummy", "hDummy", 1000000, 0, 100);
  ...
  TF1 *FitPol0[100];
  TH1F *hDummyRatio = new TH1F("hDummyRatio", "hDummyRatio", 1000000, -100, 100);
  ...
  canvas->SaveAs(Form("../CompareResults/Canvas_CompareResults%i%s.png", TypeComp, AdditionalName.Data()));
  canvas->SaveAs(Form("../CompareResults/Canvas_CompareResults%i%s.pdf", TypeComp, AdditionalName.Data()));
  ...
  leg->Draw("same");
  canvas2->SaveAs(Form("../CompareResults/Canvas_CompareResults%i_NoRatio%s.png", TypeComp, AdditionalName.Data()));
  canvas2->SaveAs(Form("../CompareResults/Canvas_CompareResults%i_NoRatio%s.pdf", TypeComp, AdditionalName.Data()));
