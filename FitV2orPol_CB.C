...
double twoGauss_plus_cheb(double *x, double *p)
{

  double signal = p[0] * exp(-0.5 * ((x[0] - p[1]) / p[2]) * ((x[0] - p[1]) / p[2])) + p[3] * exp(-0.5 * ((x[0] - p[4]) / p[5]) * ((x[0] - p[4]) / p[5]));

  double xx = x[0];

  // rescale to [xmin,  xmax] if needed
  double xmin = p[6], xmax = p[7];
  double t = (2 * xx - (xmax + xmin)) / (xmax - xmin);
...
double oneGauss_plus_cheb(double *x, double *p)
{

  double signal = p[0] * exp(-0.5 * ((x[0] - p[1]) / p[2]) * ((x[0] - p[1]) / p[2]));

  double xx = x[0];

  // rescale to [xmin,  xmax] if needed
  double xmin = p[3], xmax = p[4];
  double t = (2 * xx - (xmax + xmin)) / (xmax - xmin);
    ...
    Bool_t isSysMultTrial = ExtrisSysMultTrial)
{
  ...
  TH1F *histoMeanPtInt = new TH1F("histoMeanPtInt", "histoMeanPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoMean1 = new TH1F("histoMean1", "histoMean1", numPtBinsVar, BinsVar);
  TH1F *histoMean1PtInt = new TH1F("histoMean1PtInt", "histoMean1PtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoMean2 = new TH1F("histoMean2", "histoMean2", numPtBinsVar, BinsVar);
  TH1F *histoMean2PtInt = new TH1F("histoMean2PtInt", "histoMean2PtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSigma = new TH1F("histoSigma", "histoSigma", numPtBinsVar, BinsVar);
  TH1F *histoSigmaPtInt = new TH1F("histoSigmaPtInt", "histoSigmaPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSigma1 = new TH1F("histoSigma1", "histoSigma1", numPtBinsVar, BinsVar);
  TH1F *histoSigma1PtInt = new TH1F("histoSigma1PtInt", "histoSigma1PtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSigma2 = new TH1F("histoSigma2", "histoSigma2", numPtBinsVar, BinsVar);
  TH1F *histoSigma2PtInt = new TH1F("histoSigma2PtInt", "histoSigma2PtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSigmaWeighted = new TH1F("histoSigmaWeighted", "histoSigmaWeighted", numPtBinsVar, BinsVar);
  TH1F *histoSigmaPtIntWeighted = new TH1F("histoSigmaPtIntWeighted", "histoSigmaPtIntWeighted", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoPurity = new TH1F("histoPurity", "histoPurity", numPtBinsVar, BinsVar);
  TH1F *histoPurityPtInt = new TH1F("histoPurityPtInt", "histoPurityPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSignificance = new TH1F("histoSignificance", "histoSignificance", numPtBinsVar, BinsVar);
  TH1F *histoSignificancePtInt = new TH1F("histoSignificancePtInt", "histoSignificancePtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoYield = new TH1F("histoYield", "histoYield", numPtBinsVar, BinsVar);
  TH1F *histoYieldPtInt = new TH1F("histoYieldPtInt", "histoYieldPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  ...
  TH1F *histoYieldFractionPtInt = new TH1F("histoYieldFractionPtInt", "histoYieldFractionPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  ...
  TH1F *histoTotPtInt = new TH1F("histoTotPtInt", "histoTotPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoB = new TH1F("histoB", "histoB", numPtBinsVar, BinsVar);
  TH1F *histoBPtInt = new TH1F("histoBPtInt", "histoBPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);

  TH1F *histoMeanDSCB = new TH1F("histoMeanDSCB", "histoMeanDSCB", numPtBinsVar, BinsVar);
  TH1F *histoMeanDSCBPtInt = new TH1F("histoMeanDSCBPtInt", "histoMeanDSCBPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoSigmaDSCB = new TH1F("histoSigmaDSCB", "histoSigmaDSCB", numPtBinsVar, BinsVar);
  TH1F *histoSigmaDSCBPtInt = new TH1F("histoSigmaDSCBPtInt", "histoSigmaDSCBPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histonRDSCB = new TH1F("histonRDSCB", "histonRDSCB", numPtBinsVar, BinsVar);
  TH1F *histonRDSCBPtInt = new TH1F("histonRDSCBPtInt", "histonRDSCBPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histonLDSCB = new TH1F("histonLDSCB", "histonLDSCB", numPtBinsVar, BinsVar);
  TH1F *histonLDSCBPtInt = new TH1F("histonLDSCBPtInt", "histonLDSCBPtInt", 1, MinPt[ChosenPart], BinsVar[numPtBinsVar]);
  TH1F *histoAlphaRDSCB = new TH1F("histoAlphaRDSCB", "histoAlphaRDSCB", numPtBinsVar, BinsVar);
  ...
  TF1 **functionDSCBPre = new TF1 *[numPtBins + 1];
  TF1 **functionDSCBPost = new TF1 *[numPtBins + 1];
  ...
  Double_t parTwoGaussCheb[numPtBins + 1][8];
  ...
  Double_t parOneGaussCheb[numPtBins + 1][5];
  ...
  for (Int_t pt = 0; pt < numPtBinsVar + 1; pt++)
  {
    ...
    functionDSCBPre[pt] = new TF1(Form("DSCBf_%i", pt), dscb, min_range_signal[ChosenPart], max_range_signal[ChosenPart], 7);
    functionDSCBPre[pt]->SetLineColor(881);
    functionDSCBPre[pt]->SetParameter(1, ParticleMassPDG[ChosenPart]);
    functionDSCBPre[pt]->SetParName(0, "norm");
    functionDSCBPre[pt]->SetParName(1, "mean");
    functionDSCBPre[pt]->SetParName(2, "sigma");
    functionDSCBPre[pt]->SetParName(3, "alphaL");
    functionDSCBPre[pt]->SetParName(4, "nL");
    functionDSCBPre[pt]->SetParName(5, "alphaR");
    functionDSCBPre[pt]->SetParName(6, "nR");
    // functionDSCBPre[pt]->SetParLimits(1, min_range_signal[ChosenPart], max_range_signal[ChosenPart]);
    // functionDSCBPre[pt]->SetParLimits(2, 0.001, 0.1);
    // functionDSCBPre[pt]->SetParLimits(0, 0, 1.1 * hInvMass[pt]->GetBinContent(hInvMass[pt]->GetMaximumBin()));
    ...
    functionDSCBPost[pt] = new TF1(Form("DSCBf_%i_final", pt), dscb, gaussDisplayRangeLow[ChosenPart], gaussDisplayRangeUp[ChosenPart], 7);
    functionDSCBPost[pt]->SetLineColor(kRed);
    functionDSCBPost[pt]->SetParName(0, "norm");
    functionDSCBPost[pt]->SetParName(1, "mean");
    functionDSCBPost[pt]->SetParName(2, "sigma");
    functionDSCBPost[pt]->SetParName(3, "alphaL");
    functionDSCBPost[pt]->SetParName(4, "nL");
    functionDSCBPost[pt]->SetParName(5, "alphaR");
    functionDSCBPost[pt]->SetParName(6, "nR");
    ...
    if (UseTwoGauss && !isFitDSCB)
    {
      ...
      if (BkgType == 0)
        ...
        total[pt] = new TF1(Form("total%i", pt), twoGauss_plus_cheb, liminf[ChosenPart], limsup[ChosenPart], 13);
      ...
      if (BkgType == 0)
        ...
        hInvMass[pt]->Fit(bkgcheb[pt], "RB0");
      ...
      {
        functionsFirst[pt]->GetParameters(&parTwoGaussCheb[pt][0]);
        functionsSecond[pt]->GetParameters(&parTwoGaussCheb[pt][3]);
        bkgcheb[pt]->GetParameters(&parTwoGaussCheb[pt][6]);
        total[pt]->SetParameters(parTwoGaussCheb[pt]);
        total[pt]->FixParameter(6, liminf[ChosenPart]);
        total[pt]->FixParameter(7, limsup[ChosenPart]);
      }
      ...
      else if (BkgType == 4)
      {
        ...
        totalSignal[pt]->FixParameter(12, 0);
      }
      ...
      {
        bkg5[pt]->FixParameter(0, total[pt]->GetParameter(6));
        bkg5[pt]->FixParameter(1, total[pt]->GetParameter(7));
        bkg5[pt]->FixParameter(2, total[pt]->GetParameter(8));
        bkg5[pt]->FixParameter(3, total[pt]->GetParameter(9));
        bkg5[pt]->FixParameter(4, total[pt]->GetParameter(10));
        bkg5[pt]->FixParameter(5, total[pt]->GetParameter(11));
        bkg5[pt]->FixParameter(6, total[pt]->GetParameter(12));
    ...
    if ((!UseTwoGaussUpdated || !UseTwoGauss) && !isFitDSCB)
    {
      ...
      if (BkgType == 0)
        ...
        total[pt] = new TF1(Form("total%i", pt), oneGauss_plus_cheb, liminf[ChosenPart], limsup[ChosenPart], 10);
      ...
      {
        functionsFirst[pt]->GetParameters(&parOneGaussCheb[pt][0]);
        bkgcheb[pt]->GetParameters(&parOneGaussCheb[pt][3]);
        total[pt]->SetParameters(parOneGaussCheb[pt]);
        total[pt]->FixParameter(3, liminf[ChosenPart]);
        total[pt]->FixParameter(4, limsup[ChosenPart]);
      }
      ...
      {
        bkg5[pt]->FixParameter(0, total[pt]->GetParameter(3));
        bkg5[pt]->FixParameter(1, total[pt]->GetParameter(4));
        bkg5[pt]->FixParameter(2, total[pt]->GetParameter(5));
        bkg5[pt]->FixParameter(3, total[pt]->GetParameter(6));
        bkg5[pt]->FixParameter(4, total[pt]->GetParameter(7));
        bkg5[pt]->FixParameter(5, total[pt]->GetParameter(8));
        bkg5[pt]->FixParameter(6, total[pt]->GetParameter(9));
        bkgFunction = (TF1 *)bkg5[pt]->Clone(Form("bkgFunction5_%i", pt));
      }
      if (pt < 4)
        canvas[0]->cd(pt + 1);
    ...
    if (isFitDSCB)
    {
      ...
      cout << "\n\n fit dscb " << endl;
      functionDSCBPre[pt]->SetParameter(0, 0.5 * hInvMass[pt]->GetBinContent(hInvMass[pt]->GetMaximumBin()));
      functionDSCBPre[pt]->SetParameter(1, ParticleMassPDG[ChosenPart]);
      functionDSCBPre[pt]->SetParameter(2, 0.002);
      functionDSCBPre[pt]->SetParameter(3, 3);     // alphaL
      functionDSCBPre[pt]->SetParLimits(3, 0, 10); // alphaL
      functionDSCBPre[pt]->SetParameter(4, 1);     // nL
      functionDSCBPre[pt]->SetParameter(5, 3);     // alphaR
      functionDSCBPre[pt]->SetParLimits(5, 0, 10); // alphaR
      functionDSCBPre[pt]->SetParameter(6, 1);     // nR
      ...
      if (isMC)
      {
        functionDSCBPre[pt]->GetParameters(&parDSCBMC[pt][0]);
        total[pt]->SetParameters(parDSCBMC[pt]);
      }
      else
      {
        if (BkgType == 0)
      ...
      functionDSCBPost[pt]->FixParameter(2, total[pt]->GetParameter(2));
      functionDSCBPost[pt]->FixParameter(3, total[pt]->GetParameter(3));
      functionDSCBPost[pt]->FixParameter(4, total[pt]->GetParameter(4));
      functionDSCBPost[pt]->FixParameter(5, total[pt]->GetParameter(5));
      functionDSCBPost[pt]->FixParameter(6, total[pt]->GetParameter(6));
      ...
      if (pt < numPtBinsVar)
      {
        histoMeanDSCB->SetBinContent(pt + 1, mean[pt]);
        histoMeanDSCB->SetBinError(pt + 1, errmean[pt]);
        histoSigmaDSCB->SetBinContent(pt + 1, sigma[pt]);
        histoSigmaDSCB->SetBinError(pt + 1, errsigma[pt]);
        histoAlphaLDSCB->SetBinContent(pt + 1, total[pt]->GetParameter(3));
        histoAlphaRDSCB->SetBinContent(pt + 1, total[pt]->GetParameter(5));
        histonLDSCB->SetBinContent(pt + 1, total[pt]->GetParameter(4));
        histonRDSCB->SetBinContent(pt + 1, total[pt]->GetParameter(6));
      }
      else
      {
        histoMeanDSCBPtInt->SetBinContent(1, mean[pt]);
        histoMeanDSCBPtInt->SetBinError(1, errmean[pt]);
        histoSigmaDSCBPtInt->SetBinContent(1, sigma[pt]);
        histoSigmaDSCBPtInt->SetBinError(1, errsigma[pt]);
        histoAlphaLDSCBPtInt->SetBinContent(1, total[pt]->GetParameter(3));
        histoAlphaRDSCBPtInt->SetBinContent(1, total[pt]->GetParameter(5));
        histonLDSCBPtInt->SetBinContent(1, total[pt]->GetParameter(4));
        histonRDSCBPtInt->SetBinContent(1, total[pt]->GetParameter(6));
      }
    }
    ...
    if (!isMC)
    {
      ...
      PzBkgError = sqrt(pow(mean[pt] * v2FitFunction[pt]->GetParError(2), 2) + pow(v2FitFunction[pt]->GetParError(1), 2) + 2 * covV2Bkg * mean[pt]);
    ...
    cout << "UseTwo Gauss " << UseTwoGauss << " UseTwoGaussUpdated " << UseTwoGaussUpdated << " BkgType " << BkgType << " isFitDSCB " << isFitDSCB << endl;
    if (isCombinedFit && (!UseTwoGaussUpdated || !UseTwoGauss || BkgType != 1 || isFitDSCB))
    {
      cout << "\e[36mCombined fit only works with two gaussians and a 2nd degree polynomial. Set isCombinedFit = 0 or change function type\e[39m" << endl;
      return;
    }
    if (isCombinedFit)
    {
  ...
  Double_t CCascToLambda = 0;
  if (ParticleType == 0) // Omega
    CCascToLambda = COmegaToLambda;
  else if (ParticleType == 1) // Xi
    CCascToLambda = CXiToLambda;
  if (!isV2)
  {
    if (isPolFromLambda)
    {
  ...
  if (isMC && isFitDSCB)
  {
    outputfile->WriteTObject(histoMeanDSCB);
  ...
  if (ParticleType == 1)
    ...
    histo->GetYaxis()->SetRangeUser(0.0001, 199);
  if (ChosenPart >= 6)
  ...
  if (isFitDSCB)
  {
    if (isMC)
    {
      totalPNorm = new TF1("totalP", dscb, XRangeMin[ChosenPart], XRangeMax[ChosenPart], 7);
    }
    else
    {
      if (BkgType == 0)
  ...
  else
  {
    ...
    {
      totalPNorm = new TF1("totalP", twoGauss_plus_cheb, XRangeMin[ChosenPart], XRangeMax[ChosenPart], 13);
      totalPNorm->SetParameter(6, total[ChosenPt]->GetParameter(6));
      totalPNorm->SetParameter(7, total[ChosenPt]->GetParameter(7));
      totalPNorm->SetParameter(8, total[ChosenPt]->GetParameter(8) / histoIntegral);
      totalPNorm->SetParameter(9, total[ChosenPt]->GetParameter(9) / histoIntegral);
      totalPNorm->SetParameter(10, total[ChosenPt]->GetParameter(10) / histoIntegral);
